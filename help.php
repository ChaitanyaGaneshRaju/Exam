    	    ...
    	    <div class="side-bar">
                <ul>
                    ...
                    <div class="menu">
                        ...
                        <li>
                            <a href="help.php" class="active">Help<span id="label" class="pull-right"></span></a>
                        </li>
                        <li>
            ...
            <div class="flex content" id="content">
                ...
                <div class="col-md-12 " id="col1">
                    <div class="panel panel-default" id="panel">
                        <div class="panel-heading"><h3><b>Help</b></h3><h5 id="demo"></h5></div>
                        <div id="panelbody">
                        <p id="name"><?php echo "Hello ".$_SESSION['username'].",";?></p>
                        <li>For any assist, contact the faculties or co-ordinators in your room.</li>
                        <h4><b>Developer Contact:</b></h4>
                        <img id="dev" src="img/chaitanya.jpeg"/>
                        <div id="dev-info">
                        <dt>Sarikonda Chaitanya GaneshRaju</dt>
                        <dt>Phone: +91 9100536459</dt>
                        <dt>Email: chaitanyaraju2000@gmail.com</dt>
                        <dt>LinkedIn:<a href="#">linkedin.com/in/chaitanyaganesh</a></dt>
                        </div>
                        </div>
                    </div>
                </div>  
